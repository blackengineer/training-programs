...
const Privacy = () => {
  return (
    <div className='mt-20'>
      ...
      <h2 className='pl-6 pr-6 text-base uppercase font-semibold mt-6'>
        Introduction
      </h2>
      <p className='pl-6 pr-6 text-sm mt-4'>
        ...
        voluntary, but without it You may not be able to receive Our Services.
        By providing Your personal information, You consent to do so for the
        purpose of delivering to You the Service.
      </p>
      <p className='pl-6 pr-6 text-sm mt-4'>
      ...
      <p className='pl-6 pr-6 text-sm mt-4'>
        ...
        of your personal data shall be governed according to the privacy laws
        of the State of California, USA.
      </p>
      <p className='pl-6 pr-6 text-sm mt-4'>
        Our Company is responsible for personal data: Muscle Development
        Platforms, with registered offices in 3019 Ocean Park Blvd, STE 224,
        Santa Monica, CA, US 90405.
      </p>
      <p className='pl-6 pr-6 text-sm mt-4'>
      ...
      <p className='pl-6 pr-6 text-sm mt-4'>
        ...
        than 13. We may but are not obligated to use your personal
      ...
      <p className='pl-6 pr-6 text-sm mt-4'>
        <span className='font-semibold'>Personal Information Provided by You:</span> We collect first name,
      ...
      <ul className='pl-16 pr-6 text-sm mt-4 list-disc space-y-2'>
        ...
        <li>To be able to contact You with general or personalized servicerelated notices and promotional messages/emails;</li>
      ...
      <ul className='pl-16 pr-6 text-sm mt-4 list-disc space-y-2'>
        <li>
          <span className='font-semibold'>To facilitate account creation and login process.</span> We use the
        ...
        <li>
          <span className='font-semibold'>To send administrative information to You.</span> We may use Your
        ...
        <li>
          <span className='font-semibold'>Fulfill and manage Your purchases.</span> We may use Your
          information to fulfill and manage Your purchases made through
          Our Website;
        </li>
        <li>
          <span className='font-semibold'>To enforce Our terms, conditions and policies for Business
          Purposes, Legal Reasons and Contractual;</span>
        </li>
        <li>
          <span className='font-semibold'>To manage User Account.</span> We may use Your information for the
          purposes of managing Your account and keeping it in working
          order;
        </li>
        <li>
          <span className='font-semibold'>To respond to legal requests and prevent harm.</span> If We receive a
        ...
        <li>
          <span className='font-semibold'>To deliver services to the user.</span> We may use Your information to
          provide You with the Services/Products.
        </li>
        <li>
          <span className='font-semibold'>For other Business Purposes.</span> We may use Your information for
      ...
      <ul className='pl-16 pr-6 text-sm mt-4 list-disc space-y-2'>
        <li>
          <span className='font-semibold'>Legitimate Interests:</span> We may process Your data when it is
          reasonably necessary to achieve Our legitimate business
          interests.
        </li>
        <li>
          <span className='font-semibold'>Legal Obligations:</span> if We reasonably suspect that Your Account
        ...
        <li>
          <span className='font-semibold'>Vital Interests:</span> We may disclose Your information where We
      ...
      <h2 className='pl-6 pr-6 text-base font-semibold mt-6'>
        ...
        <p className='pl-6 pr-6 text-sm mt-4'>
          ...
          jimmy@howtotrainfor.com. You will then be removed from the
      ...
      <h2 className='pl-6 pr-6 text-base font-semibold mt-6'>
        ...
        <p className='pl-6 pr-6 text-sm mt-4'>
          ...
          contacting Us at jimmy@howtotrainfor.com and providing Us with Your
          name and the email address associated with Your account. Please
          kindly note that We do not currently sell Your personal information as
      ...
      <h2 className='pl-6 pr-6 text-base font-semibold mt-6'>
        ...
        <p className='pl-6 pr-6 text-sm mt-4'><span className='font-semibold'>Address:</span> 3019 Ocean Park Blvd, STE 224, Santa Monica, CA, US
        90405</p>
        <p className='pl-6 pr-6 text-sm mt-4'><span className='font-semibold'>Email:</span> jimmy@howtotrainfor.com</p>
      <h2 className='pl-6 pr-6 text-base font-semibold mt-6'>
        Changes
      </h2>
        <p className='pl-6 pr-6 text-sm mt-4'>
